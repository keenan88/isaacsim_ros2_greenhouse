...
class GoalPoseServer(Node):
    def __init__(self):
        ...
        self.pose_stamped.pose.position.y = -2.0 # Assumes robot starts at (0,0,0), (0,0,0)

        self.pose_stamped.pose.orientation.z = -0.7071068
        self.pose_stamped.pose.orientation.w = 0.7071068
